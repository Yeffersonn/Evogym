  ...
  return (
    <nav>
            ...
            {isAboveMediumScreens ? (
              <div className={`${flexBetween} w-full`}>
                ...
                <div className={`${flexBetween} gap-8`}>
                  <p className="hover:text-primary-500 cursor-pointer">Sign In</p>
      ...
      {!isAboveMediumScreens && isMenuToggled && (
        <div className={`${isMenuToggled && "animate-modal"} fixed right-0 bottom-0 z-50 h-full w-[300px] bg-gray-20 shadow-lg`}>
          {/* CLOSE ICON */}
